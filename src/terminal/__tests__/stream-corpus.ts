...
export const STREAM_CORPUS: readonly (readonly [string, string])[] = [
  ...
  ['sgr 256 and truecolor', `${CSI}38;5;196mA${CSI}48;2;12;34;56mB${CSI}38:2::21:42:63mC${CSI}0m\n`],
  ['sgr attributes', `${CSI}3mitalic ${CSI}4munder ${CSI}9mstrike ${CSI}7minverse ${CSI}2mdim ${CSI}8mhidden${CSI}0m\n`],
  ...
  ['erase and delete cells', `abcdef${CSI}2G${CSI}2X\nabcdef${CSI}2G${CSI}2P\nabcdef${CSI}2G${CSI}2@\n`],
  ...
  ['modes', `${CSI}?25lhidden${CSI}?25h${CSI}?7lnowrap${CSI}?7h${CSI}4hins${CSI}4l${CSI}?1h${CSI}?2004hend\n`],
